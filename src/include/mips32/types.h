...
#define MIPS32_F_SETFL		4

#define MIPS32_MAP_SHARED	0x000001
#define MIPS32_MAP_PRIVATE	0x000002
#define MIPS32_MAP_FIXED	0x000010
#define MIPS32_MAP_NORESERVE	0x000400
#define MIPS32_MAP_ANONYMOUS	0x000800
#define MIPS32_MAP_DENYWRITE	0x002000
#define MIPS32_MAP_STACK	0x040000

#define MIPS32_O_RDONLY		0x00000
#define MIPS32_O_WRONLY		0x00001
#define MIPS32_O_RDWR		0x00002
#define MIPS32_O_APPEND		0x00008
#define MIPS32_O_NONBLOCK	0x00080
#define MIPS32_O_CREAT		0x00100
#define MIPS32_O_TRUNC		0x00200
#define MIPS32_O_EXCL		0x00400
#define MIPS32_O_LARGEFILE	0x02000
#define MIPS32_O_DIRECTORY	0x10000
#define MIPS32_O_CLOEXEC	0x80000

#define MIPS32_POLL_IN		0x0001
#define MIPS32_POLL_PRI		0x0002
#define MIPS32_POLL_OUT		0x0004
#define MIPS32_POLL_WRNORM	0x0004
#define MIPS32_POLL_RDNORM	0x0040
#define MIPS32_POLL_RDBAND	0x0080
#define MIPS32_POLL_WRBAND	0x0100
